...
export async function fetchRetroBoards(teamId: string, includeDeleted: boolean = false): Promise<RetroBoardRecord[]> {
    if (shouldUseCSharpApi()) {
        const { apiGetRetroBoards } = await import('@/lib/apiClient');
...
export async function fetchRetroBoardTitles(boardIds: string[]): Promise<Array<{ id: string; title: string }>> {
    if (shouldUseCSharpApi()) {
        const { apiGetRetroBoardTitlesByIds } = await import('@/lib/apiClient');
...
export async function createRetroBoard(params: {
    ...
    if (shouldUseCSharpApi()) {
        const { apiCreateRetroBoard } = await import('@/lib/apiClient');
...
export async function updateRetroBoard(boardId: string, updates: {
    ...
    if (shouldUseCSharpApi()) {
        const { apiUpdateRetroBoard } = await import('@/lib/apiClient');
...
export async function deleteRetroBoard(boardId: string): Promise<void> {
    if (shouldUseCSharpApi()) {
        const { apiDeleteRetroBoard } = await import('@/lib/apiClient');
...
export async function fetchRetroBoardConfig(boardId: string): Promise<RetroBoardConfigRecord | null> {
    if (shouldUseCSharpApi()) {
        const { apiGetRetroBoardConfig } = await import('@/lib/apiClient');
        try {
...
export async function createRetroBoardConfig(boardId: string, config: Partial<RetroBoardConfigRecord>): Promise<RetroBoardConfigRecord> {
    if (shouldUseCSharpApi()) {
        const { apiCreateRetroBoardConfig } = await import('@/lib/apiClient');
        try {
...
export async function updateRetroBoardConfig(boardId: string, updates: Partial<RetroBoardConfigRecord>): Promise<void> {
    if (shouldUseCSharpApi()) {
        const { apiUpdateRetroBoardConfig } = await import('@/lib/apiClient');
        try {
...
export async function fetchRetroColumns(boardId: string): Promise<RetroColumnRecord[]> {
    if (shouldUseCSharpApi()) {
        const { apiGetRetroColumns } = await import('@/lib/apiClient');
        try {
...
export async function createRetroColumn(boardId: string, title: string, color: string, position: number, isActionItems?: boolean, sortOrder?: number): Promise<RetroColumnRecord> {
    if (shouldUseCSharpApi()) {
        const { apiCreateRetroColumn } = await import('@/lib/apiClient');
        try {
...
export async function updateRetroColumn(columnId: string, updates: Partial<RetroColumnRecord>): Promise<void> {
    if (shouldUseCSharpApi()) {
        const { apiUpdateRetroColumn } = await import('@/lib/apiClient');
        try {
...
export async function deleteRetroColumn(columnId: string): Promise<void> {
    if (shouldUseCSharpApi()) {
        const { apiDeleteRetroColumn } = await import('@/lib/apiClient');
        try {
...
export async function updateRetroColumnsBatch(updates: Array<{ id: string; position: number; sort_order: number }>): Promise<void> {
    if (shouldUseCSharpApi()) {
        const { apiUpdateRetroColumnsBatch } = await import('@/lib/apiClient');
        try {
...
export async function fetchCommentsForItems(itemIds: string[]): Promise<any[]> {
    ...
    if (shouldUseCSharpApi()) {
        const { apiGetCommentsByItemIds } = await import('@/lib/apiClient');
...
export async function fetchCommentsForItem(itemId: string): Promise<any[]> {
    if (shouldUseCSharpApi()) {
        const { apiGetCommentsByItemId } = await import('@/lib/apiClient');
...
export async function addRetroComment(params: { itemId: string; text: string; author: string; authorId?: string | null; sessionId?: string | null }): Promise<any> {
    if (shouldUseCSharpApi()) {
        const { apiCreateComment } = await import('@/lib/apiClient');
...
export async function deleteRetroComment(commentId: string): Promise<void> {
    if (shouldUseCSharpApi()) {
        const { apiDeleteComment } = await import('@/lib/apiClient');
